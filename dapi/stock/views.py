...
def home(request):
    ...
    if request.method == 'POST':
        ...
        api_request = requests.get("https://cloud.iexapis.com/stable/stock/" +
                                   ticker + "/quote?token=pk_29d0b498238d4b81b8551c50862b6474")
        ...
        return render(request, "stock/home.html", {'ticker': 'Enter a Ticker Symbol Above...'})
...
def add_stock(request):
    ...
    if request.method == 'POST':
        ...
        for ticker_item in ticker:
            api_request = requests.get("https://cloud.iexapis.com/stable/stock/" +
                                       str(ticker_item) + "/quote?token=pk_29d0b498238d4b81b8551c50862b6474")
